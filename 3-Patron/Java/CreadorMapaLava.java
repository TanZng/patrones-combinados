...
public class CreadorMapaLava extends CreadorDeMapa{

    public CreadorMapaLava(IMapa mapa) {
        super(mapa);
    }
    ...
    public Mapa CrearMapa() {
        ...
        Textura textura = new Textura("nieve.png",100,200);
        Tesoro tesoro = new Tesoro(100,1000);
